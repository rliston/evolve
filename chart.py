...
lmean = parselog(args.log,27)
lmax = parselog(args.log,29)
lstd = parselog(args.log,35)
...
ax1.plot(n,node[0:len(n)],'-g',linewidth=1)
ax11.plot(n,depth[0:len(n)],'-m',linewidth=1)
ax1.plot(n,leaf[0:len(n)],'-k',linewidth=1)

#ax1.plot(n,back[0:len(n)],'-m')
#ax1.plot(n,r[0:len(n)],'-g')
ax2.plot(n,pop[0:len(n)],'-r',linewidth=1)
#ax2.plot(n,pmean[0:len(n)],'-k')
ax3.plot(n, life[0:len(n)], '-b',linewidth=1)
#ax3.plot(n, lmean[0:len(n)], '-k', linewidth=1)
ax3.plot(n, lmax[0:len(n)], '--k', linewidth=1)
ax3.plot(n, lstd[0:len(n)]+lmean[0:len(n)], '-k', linewidth=1)
...
ax1.yaxis.set_major_formatter(FuncFormatter(lambda x, p: '{:6.0f}'.format(x)))
...
ax1.text(-0.075, 0.6, 'pool', horizontalalignment='center', verticalalignment='center', transform=ax1.transAxes,color='g',rotation=90)
ax1.text(-0.075, 0.3, 'leaf', horizontalalignment='center', verticalalignment='center', transform=ax1.transAxes,color='k',rotation=90)
